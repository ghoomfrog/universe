This repository hosts world-improving ideas beyond one's ability to realize, stored as markdown files in their respective (main) topic folders.
...
You can also create pull requests enhancing an existing idea and describing the reasoning behind your changes. If you want to contribute in other ways to an idea, open an issue about it. Don't forget to label your issue.
