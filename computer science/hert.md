...
The processor includes an allocation bit array for every allocatable chunk which is 128 blocks. The array has 268435456 bits (32MB). The processor can only cover up to 268435456 blocks (256GB) of memory.
...
--------------------|----|-----------
Lingerence          |1b  |Whether to extend the execution of the current process by one instruction/cycle
